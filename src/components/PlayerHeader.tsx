    ...
    <div className="glass-card" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={styles.container}>
        ...
        {rank && rankImageUrl ? (
          <div style={styles.rankSection}>
            ...
            <div style={styles.statsGrid}>
              ...
              <div style={styles.statCard}>
                ...
                <div style={styles.statLabel}>Winrate</div>
              </div>
              <div style={styles.statCard}>
                <div style={styles.wlRow}>
                  <span style={styles.winValue}>{rank.wins}</span>
                  <span style={styles.wlDivider}>/</span>
                  <span style={styles.lossValue}>{rank.losses}</span>
                </div>
          ...
          <div style={styles.unrankedContainer}>
            <div style={styles.unrankedIcon}>
              <svg style={{ width: '64px', height: '64px', color: 'rgba(156, 163, 175, 0.6)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
            </div>
            <h3 style={styles.unrankedTitle}>Unranked</h3>
            <p style={styles.unrankedText}>This player hasn't played any ranked games this season yet</p>
          </div>
        )}
      </div>
    </div>
