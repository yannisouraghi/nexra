              ...
              <div style={styles.inputGroup}>
                ...
                <div className="relative w-full">
                  <input
                    ...
                    className="w-full pr-12 py-3 px-4 text-[15px] bg-white/5 border border-white/10 rounded-[10px] text-white outline-none transition-all focus:border-cyan-400/50 focus:bg-white/[0.08] placeholder:text-white/30"
                  />
                  <button
                    type="button"
